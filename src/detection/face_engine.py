...
# Hardcoded eye-index sets from the MediaPipe 478-point canonical topology.
# These are used for 5-point landmark computation (eye-centre averaging) in
# FaceEngine.  They are hardcoded here to avoid pulling mesh-topology
# connection lists (~170 lines) into the engine file.
# ponytail: hardcoded to keep engine file small; frozen MediaPipe values.
LEFT_EYE_INDICES = {
    33,
    7,
    163,
